...
import { marketingSite, marketingProof } from "@/lib/marketing-content";
...
export function MarketingHero() {
  const [main, accent] = marketingSite.headline.split("Paying Customers");
    ...
    >
      ...
      >
        <div className="max-w-4xl">
          ...
          >
            <GlowButton
              href={marketingSite.contact.calendly}
              external
              variant="primary"
              cta="calendly"
            >
