...
import { webSite, webProof } from "@/lib/web-content";
...
export function WebHero() {
  const [main, accent] = webSite.headline.split("Customers");
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.dl
          variants={item}
          className="mt-16 grid max-w-3xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-3"
        >
          {webProof.map((metric) => (
