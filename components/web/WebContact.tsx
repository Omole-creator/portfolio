...
import { webSite, webTracks } from "@/lib/web-content";
...
export function WebContact() {
  return (
    <section id="contact" className="border-t border-line bg-paper py-24 md:py-32">
          ...
          <div className="mt-12 rounded-2xl bg-navy p-8 text-white md:flex md:items-center md:justify-between md:p-10">
            <div>
              ...
              <p className="mt-2 text-white/70">
                Tell me about your website, or send the link to the one you have now. I reply quickly.
              </p>
            </div>
